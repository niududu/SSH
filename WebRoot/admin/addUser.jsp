...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="main.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="userAction">用户管理</a><span class="crumb-step">&gt;</span><span>增加用户</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="userAction!register" method="post" id="myform" name="myform">
