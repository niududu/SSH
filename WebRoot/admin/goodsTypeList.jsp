...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="main.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">商品类别管理</span></div>
        </div>
            ...
            <form action=" " name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="goodsTypeAction!addGoodsType"><i class="icon-font"></i>增加商品类型</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td><s:property value="goodsTypeId"/></td>
                            <td><s:property value="goodsTypeName"/></td>
                            <!--  
                            <td><img src="../" width="50px" height="50px"></td> 
                            -->
                            <td>
                                <a class="link-update" href="goodsTypeAction!findGoodsTypeById?goodsTypeId=<s:property value="goodsTypeId"/>">修改</a>
                                <a class="link-del" href="goodsTypeAction!deleteGoodsTypeById?goodsTypeId=<s:property value="goodsTypeId"/>">删除</a>
                            </td>
                        </tr> 
                         </s:iterator>
                    </table>
                    <div class="list-page"> 
                    	...
                    	<a href="goodsTypeAction?currentPage=${currentPage-1}">上一页</a>
                    	<a href="goodsTypeAction?currentPage=${currentPage+1}">下一页</a>
                    </div>
                </div>
            </form>
        </div>
